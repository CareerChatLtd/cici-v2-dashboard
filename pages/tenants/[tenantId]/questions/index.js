...
/**
 * This page allows an admin user to manage the questions for a tenant.
 * They can add, edit and delete questions.
 *
 * Questions can be on of the following types: text, single choice, yes/no
 *
 * Each question has the following properties:
 *  - name: the short name for the question used in the admin UI
 *  - text: the question text shown to the user
 *  - type: the type of question (text, single choice, yes/no)
 *  - options: the options for single choice questions
 *  - includeInHandover: whether the question should be included in the handover email
 *
 * @param tenant
 * @returns {JSX.Element}
 * @constructor
 */
const ListQuestions = ({tenant}) => {
